...
assert.equal(concordance.length,27530);
assert.equal(index.pageCount,27530);
...
console.log('PASS: 729 labels, restored-scene adjacency, ending order, Last Episode section, and 27,530 concordance bindings.');
