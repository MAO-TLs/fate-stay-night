...
const releaseNotesUrl = "https://github.com/MAO-TLs/fate-stay-night/releases/tag/v1.0.1";
    ...
    <section className="hero">
      ...
      <div className="hero-grid shell">
        <div className="hero-copy">
          ...
          <p className="compatibility">15.8 MB · <a href={releaseNotesUrl}>Release notes</a> · Version 1.0.1 · Windows · Réalta Nua Ultimate Edition required</p>
        </div>
