...
export default function ScriptPage(){return <main className="reader-page mao-reader-shell"><header className="reader-header"><SiteNav currentPage="script"/><div className="shell reader-intro"><p className="eyebrow">Script version v1.1.0</p><h1>Script browser</h1><p>Search {originalPassages.toLocaleString()} passages or read any of the {originalScripts.length.toLocaleString()} scripts alongside the MAO English translation, with Japanese and English available in either the original or Réalta Nua edition.</p></div></header><ScriptReader/><SiteFooter/></main>}
